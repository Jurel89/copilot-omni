...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (.omni/plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (.omni/notepads/{plan-name}/) after completing work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `Task(subagent_type="copilot-omni:architect", ...)` for architectural cross-checks
