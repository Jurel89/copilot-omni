...
Use this skill to clean AI-generated code slop without drifting scope or changing intended behavior. In copilot-omni, this is the bounded cleanup workflow for code that works but feels bloated, repetitive, weakly tested, or over-abstracted.
...
## copilot-omni Execution Posture
...
- Good fit: `copilot-omni:ai-slop-cleaner skills/ralph/SKILL.md skills/ai-slop-cleaner/SKILL.md`
...
- `/copilot-omni:ai-slop-cleaner <target>`
- `/copilot-omni:ai-slop-cleaner <target> --review`
- `/copilot-omni:ai-slop-cleaner <file-a> <file-b> <file-c>`
