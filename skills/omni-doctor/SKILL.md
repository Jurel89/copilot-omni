...
`ai-slop-cleaner`, `ask`, `autopilot`, `cancel`, `ccg`, `configure-notifications`, `deep-interview`, `deepinit`, `external-context`, `hud`, `learner`, `mcp-setup`, `omni-doctor`, `omni-setup`, `omni-teams`, `plan`, `project-session-manager`, `ralph`, `ralplan`, `release`, `sciomni`, `setup`, `skill`, `team`, `ultraqa`, `ultrawork`, `visual-verdict`, `writer-memory`
